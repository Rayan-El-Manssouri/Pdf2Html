              ...
              var Id_Text_22 = document.getElementById("text_22");
              Id_Text_22.style.left = localStorage.getItem("Left_22");
              Id_Text_22.style.top = localStorage.getItem("Top_22");

              var oWdgCursor_22 = function (sElement, sLimite) {
                var Id_Text_22 = document.getElementById("text_22");

                this.oLimite = null;
                
                this.oElement_22 = null;
                ...
                */
                this.init = function (sLimite, sElement) {  
                  this.oElement_22 = document.getElementById(sElement); 
                  this.oLimite =(sLimite === undefined)? document.documentElement:document.getElementById(sLimite);
                  if(this.oElement_22 == null || this.oLimite == null){
                    return true;
                  }//if
                  this.oElement_22.addEventListener("mousedown", this.moveDiv);
                  this.oElement_22.addEventListener("touchstart", this.moveDiv);
                  return false;
                }//fct 
              ...
              oWdgCursor_22.prototype.moveDiv  = function (oEvent){
                oEvent.preventDefault();
                if(oEvent.type=="touchstart" || oEvent.type=="mousedown"){
                  this.bDrag = true;
                  var oTouch = oEvent,
                      oRect = this.oElement_22.getBoundingClientRect();
                  if(oEvent.type=="touchstart"){
                    ...
                    if (oEvent.targetTouches.length > 0 ) {
                      for(var i = 0; i < oEvent.targetTouches.length ; i++){
                        ...
                        if(oEvent.targetTouches[i].target == this.oElement_22){
                  ...
                  this.oElement_22.addEventListener("mouseup", this.moveDiv) ;
                  ...
                  this.bDrag = false;
                  this.oElement_22.classList.remove(this.sClassDrag)
                  ...
                  this.oElement_22.removeEventListener("mouseup", this.moveDiv) ;
                  localStorage.setItem("Left_22", this.oElement_22.style.left);
                  localStorage.setItem("Top_22", this.oElement_22.style.top);
                  ...
                  if(this.bDrag == true){ 
                    this.oElement_22.classList.add(this.sClassDrag)
                    var oRect = this.getBoundingLimite(),
                        iWidth= this.oElement_22.offsetWidth,
                        iHeight = this.oElement_22.offsetHeight, 
                    ...
                    this.oElement_22.style.left = iClientX+"px";
                    this.oElement_22.style.top  = iClientY+"px";
                    }//if
                  else{
                    this.oElement_22.classList.remove(this.sClassDrag)
                  }
              ...
              document.addEventListener("DOMContentLoaded",function(){
                var oZone2_22 = new oWdgCursor_22("text_22"); 
              });